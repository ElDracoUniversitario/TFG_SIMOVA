                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="contrasenya" placeholder="Contrasenya">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.html">He oblidat la contrasenya</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="register.php">Encara no estic registrat</a>
                                    </div>
                                </div>
                            </div>
                        </div>
